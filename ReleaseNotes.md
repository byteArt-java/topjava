...
- в API добавили `/users/{id}/with-mealTos` (см. [двунаправленные отношения](https://www.codeflow.site/ru/article/jackson-bidirectional-relationships-and-infinite-recursion))
...
- рефакторинг
  ...
  - переименовал `mealTo.jsp/user.jsp` в `mealForm.jsp/userForm.jsp`
...
- добавил
 ...
 - рефакторинг
   ...
   - реализаовал обработку дублирования `user.email` и `mealTo.dateTime` через [Controller Based Exception Handling](https://spring.io/blog/2013/11/01/exception-handling-in-spring-mvc#controller-based-exception-handling)
...
- добавил:
  ...
  - [сравнение вермени исполнения запросов при различных mealTos индексах](https://drive.google.com/open?id=0B9Ye2auQ_NsFX3RLcnJCWmQ2Y0U)
...
- добавил
  ...
  - в таблицу mealTos составной индекс 
